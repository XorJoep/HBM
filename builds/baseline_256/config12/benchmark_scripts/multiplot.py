...
result_file_conf1 = sys.argv[1]
result_file_conf2 = sys.argv[2]

title_conf1= f"HBM baseline - read+write - 256 bit AXI-bus\nConfiguration 1"
title_conf2 = f"Configuration 2"
...
for subfig_n, (result_file, title) in enumerate([(result_file_conf1, title_conf1), (result_file_conf2, title_conf2)]):
