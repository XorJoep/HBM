...
def get_data(args_in):
	...
	if args_in.l > 0 and args_in.l % 8:
	...
	if args_in.c == True:
		...
		if args_in.of is not None:
			...
			print(f"WARNING: Not using full file and not writing partial file anywhere.. Will be hard to compare files.")
	else:
