...
#define KERNEL_NAME    "bd_axi_3"
#define KERNEL_VENDOR  "TUDelft"
...
#define ARG00_OFFSET 0x010
#define AXI00_PTR0_OFFSET 0x018
#define END_OF_REG_OFFSET 0x024
